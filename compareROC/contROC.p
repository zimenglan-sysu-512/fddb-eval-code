...
set terminal png size 1280, 960 enhanced font 'Verdana,22'
set key font ",12"
set size 1,1
set xtics 500
set ytics 0.1
...
plot  "rocCurves/DDFD_ContROC.txt" using 2:1 title 'DDFD' with lines lw 2 , \
			...
			"rocCurves/all_folds_pred_0.15_0.85_roc_curvesContROC.txt" using 2:1 title 'malong.' with lines lw 2, \
